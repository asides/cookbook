...
class IngredientListsControllerTest < ActionController::TestCase
  ...
  test "should create ingredient_list" do
    assert_difference('IngredientList.count') do
      post :create, ingredient_list: { ingredient_item_id: @ingredient_list.ingredient_item_id, name: @ingredient_list.name, recipe_id: @ingredient_list.recipe_id }
    end
  ...
  test "should update ingredient_list" do
    patch :update, id: @ingredient_list, ingredient_list: { ingredient_item_id: @ingredient_list.ingredient_item_id, name: @ingredient_list.name, recipe_id: @ingredient_list.recipe_id }
    assert_redirected_to ingredient_list_path(assigns(:ingredient_list))
  end
